...
class ChatsService extends GetConnect{
  Future<Response<String>> createInbox(String accessToken, String inboxCreationDTO) => post('${con.URL_SERVER}inbox/create', inboxCreationDTO, headers: {'Authorization':'Bearer $accessToken'});

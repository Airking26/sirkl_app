...
class GroupService extends GetConnect{
  ...
  Future<Response<Map<String, dynamic>>> changeAdminRole(String accessToken, String adminDTO) => post('${con.URL_SERVER}user/admin_role', adminDTO, headers: {'Authorization':'Bearer $accessToken'});

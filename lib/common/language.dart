...
class Language extends Translations{
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US':{
      ...
      c.bySigningRes: "For your security, you now have to sign a message through your wallet on the ETH main network, by signing you agree to terms and conditions and privacy policy.",

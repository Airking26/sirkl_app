...
inboxDtoFromJson(String str) => InboxCreationDto.fromJson(json.decode(str));

String inboxCreationDtoToJson(InboxCreationDto data) =>
    json.encode(data.toJson());

List<InboxCreationDto> inboxCreationListDtoFromJson(String str) =>
    List<InboxCreationDto>.from(
        json.decode(str).map((x) => InboxCreationDto.fromJson(x)));
String inboxCreationListDtoToJson(List<InboxCreationDto> data) =>
...
class InboxCreationDto {
  ...
  factory InboxCreationDto.fromJson(Map<String, dynamic> json) =>
      InboxCreationDto(

...
String contractAddressDtoToJson(ContractAddressDto data) =>
...
class ContractAddressDto {
  ...
  factory ContractAddressDto.fromJson(Map<String, dynamic> json) =>
      ContractAddressDto(
...
class Media {
  Media({this.raw, this.gateway, this.thumbnail});
  ...
  factory Media.fromJson(Map<String, dynamic> json) => Media(
      raw: json["raw"], gateway: json["gateway"], thumbnail: json["thumbnail"]);

...
class CommonService extends GetConnect{
  ...
  Future<Response<List<dynamic>>> getSirklUsers(String accessToken, String id, String offset) => get('${con.URL_SERVER}follow/$id/following/$offset', headers: {'Authorization':'Bearer $accessToken'});

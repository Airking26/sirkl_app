...
class FloatingNavbar extends StatefulWidget {
  ...
  FloatingNavbar({
    ...
    this.topMarginText = 0,
    this.unselectedItemColor = const Color(0xFF9BA0A5),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Image.asset(item.icon,scale: 3, color: currentIndex == index
                        ? selectedItemColor
                        : unselectedItemColor),
                  ),
                  SizedBox(height: topMarginText,),
                  if (item.title != null)
                    Text(
                      '${item.title}',

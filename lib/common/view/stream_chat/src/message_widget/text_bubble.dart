      ...
      child: textBuilder != null
          ...
          : StreamMessageText(
              ...
              messageTheme: isOnlyEmoji
                  ...
                  : messageTheme.copyWith(messageTextStyle: TextStyle(color: reverse ? Get.isDarkMode ? Colors.white : Colors.black : Colors.white , fontSize: 15, fontFamily: 'Gilroy', fontWeight: FontWeight.w500)),
            ),
    );
  }
}

      ...
      child: ListTile(
        onTap: (){
          ...
          ClipRRect(
            ...
            SizedBox(width: 60, height: 60, child: TinyAvatar(baseString: item.ownedBy!.first.wallet!, dimension: 56, circular: true, colourScheme: TinyAvatarColourScheme.seascape,)) :
            CachedNetworkImage(

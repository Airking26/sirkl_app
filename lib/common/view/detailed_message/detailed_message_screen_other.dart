              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(width: 250, height: 50, child: Row(
                        ...
                        children: [
                          ...
                          child: Column(
                            ...
                            Text("3245 participants",style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, fontFamily: "Gilroy", color: Get.isDarkMode ? Color(0xFF9BA0A5) : Color(0xFF828282)),)
                          ],),
                        )
                      ],),),
                ...
                child: Padding(
                  ...
                  child: Container(decoration: BoxDecoration(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                        Text("Could you make sure to involve the Head of R&D here? Could you make sure to involve the Head of R&D here?", style: TextStyle(color: Colors.white, fontFamily: "Gilroy", fontWeight: FontWeight.w500, fontSize: 15),),
                        Padding(
            ...
            child: Padding(
              ...
              child: Container(decoration: BoxDecoration(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Text("Could you make sure to involve the Head of R&D here? Could you make sure to involve the Head of R&D here?", style: TextStyle(color: Colors.black, fontFamily: "Gilroy", fontWeight: FontWeight.w500, fontSize: 15),),
                      Padding(
                        padding: const EdgeInsets.only(top: 4.0),

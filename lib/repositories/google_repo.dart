        ...
        builder: (context) => AlertDialog(
              ...
              title: const Column(
                children: [
                  ...
                  Text(
                    "Create a backup of your seed phrase to never lose the access to your wallet",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
            ...
            title: const Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "A password is required to encrypt your seed phrase on Google Drive",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),
              ...
              ElevatedButton(
                onPressed: () async {
                  if (_passwordTextController.text.isNotEmpty &&
                    ...
                    Get.back();
                    await promptConfirmationPassword(
                        context, _passwordTextController.text);
                  }
                },
                style: TextButton.styleFrom(
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  backgroundColor: _passwordTextController.text.isNotEmpty &&
                          _passwordController.areAllRulesValidated
                      ? SColors.activeColor
                      : Colors.grey,
                  shape: RoundedRectangleBorder(
...
Future<void> promptConfirmationPassword(
        ...
        return Obx(
          () => AlertDialog(
            ...
            title: const Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8.0),
                  child: Text(
                    "Check all the boxes and confirm your password",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),
                    ...
                    leading: SizedBox(
                      ...
                      child: Transform.scale(
                        ...
                        child: Checkbox(
                          ...
                          activeColor: SColors
                              .activeColor, // Checkbox background color when checked
            ...
            actions: <Widget>[
              ElevatedButton(
                onPressed: () async {
                  if (passwordAreEquals.value &&
                      acceptTermFour.value &&
                      acceptTermFive.value) {
                    Get.back();
                ...
                style: TextButton.styleFrom(
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  backgroundColor: passwordAreEquals.value &&
                          acceptTermFour.value &&
                          acceptTermFive.value
                      ? SColors.activeColor
                      : Colors.grey,
...
Future<void> promptCompleteGoogleDriveBackup(
        BuildContext context, String password) async =>
    await showDialog(
        context: context,
        builder: (context) => StatefulBuilder(
              builder: (context, setState) => AlertDialog(
                ...
                title: const Column(
                  children: [
                    Text(
                      "Name your backup for easy identification",
                      style: TextStyle(
                          fontFamily: 'Gilroy',
                          fontSize: 24,
                          fontWeight: FontWeight.w700),
                    ...
                    Text(
                      "Do not delete it from Google Drive, or you may lose your wallet",
                      style: TextStyle(
                          fontFamily: 'Gilroy',
                          fontWeight: FontWeight.w500,
                          fontSize: 14),
                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            if (_nameBackupTextController.text.isNotEmpty) {
                              await saveWalletToDrive(
                                  box.read(SharedPref.SEED_PHRASE),
                                  _nameBackupTextController.text,
                                  password);
                              Get.back();
                              backupIsLoading.value = false;
                              ...
                              Fluttertoast.showToast(
                                  msg:
                                      "Wallet saved successfully, enjoy SIRKL.io",
                          ...
                          style: TextButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 12),
                            backgroundColor:
                                _nameBackupTextController.text.isNotEmpty
                                    ? SColors.activeColor
                                    : Colors.grey,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
...
Future<void> promptBackupManuallyTerms(BuildContext context) async =>
    await showDialog(
        context: context,
        builder: (context) => Obx(() => AlertDialog(
              ...
              title: const Column(
                children: [
                  ...
                  Text(
                    "Check all the boxes to confirm that you understand the importance of your seed phrase",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),
              ...
              actions: <Widget>[
                ElevatedButton(
                  onPressed: () {
                    if (acceptTermOne.value &&
                        acceptTermTwo.value &&
                        acceptTermThree.value) {
                  ...
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    backgroundColor: acceptTermOne.value &&
                            acceptTermTwo.value &&
                            acceptTermThree.value
                        ? SColors.activeColor
                        : Colors.grey,
...
Future<void> promptCopySeedPhrase(BuildContext context) async =>
    await showDialog(
        context: context,
              ...
              builder: (context, constraints) => AlertDialog(
                ...
                title: const Column(
                  children: [
                    ...
                    Text(
                      "Never share your secret phrase with anyone, and keep it secure",
                      style: TextStyle(
                          fontFamily: 'Gilroy',
                          fontWeight: FontWeight.w500,
                          fontSize: 14),
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                                ...
                                child: Center(
                                    child: Text(
                                  "${index + 1}. ${box.read(SharedPref.SEED_PHRASE).toString().trim().split(' ')[index]}",
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                      fontFamily: 'Gilroy',
                                      fontWeight: FontWeight.w500,
  ...
  await showDialog(
      ...
      builder: (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Column(
                  ...
                  children: [
                    buildLabeledRadioButtons(context, "Word #1",
                        generateWords(words, mandatoryIndex: 0), (value) {
                      wordOneValidate.value = value == words[0];
                    }),
                    const SizedBox(
                      height: 12,
                    ),
                    buildLabeledRadioButtons(context, "Word #4",
                        generateWords(words, mandatoryIndex: 3), (value) {
                      wordTwoValidate.value = value == words[3];
                    }),
                    const SizedBox(
                      height: 12,
                    ),
                    buildLabeledRadioButtons(context, "Word #7",
                        generateWords(words, mandatoryIndex: 6), (value) {
                      wordThreeValidate.value = value == words[6];
                    }),
                    const SizedBox(
                      height: 12,
                    ),
                    buildLabeledRadioButtons(context, "Word #11",
                        generateWords(words, mandatoryIndex: 10), (value) {
            ...
            actions: <Widget>[
              Obx(() => ElevatedButton(
                    onPressed: () {
                      if (wordOneValidate.value &&
                          wordTwoValidate.value &&
                          wordThreeValidate.value &&
                          wordFourValidate.value) {
                        seedPhrase.value = null;
                        box.remove(SharedPref.SEED_PHRASE);
                        Get.back();
                        Fluttertoast.showToast(
                    ...
                    style: TextButton.styleFrom(
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      backgroundColor: wordOneValidate.value &&
                              wordTwoValidate.value &&
                              wordThreeValidate.value &&
                              wordFourValidate.value
                          ? SColors.activeColor
        ...
        builder: (context) => AlertDialog(
              ...
              title: const Column(
                children: [
                  ...
                  Text(
                    "Select the method you would like to use to retrieve your wallet",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),
            ...
            )).then((v) => _navigationController.hideNavBar.value =
        _homeController.accessToken.value.isNullOrBlank! ? true : false);
Future<void> promptChoseFileGoogleDrive(BuildContext context) async =>
    await showDialog(
        context: context,
        builder: (context) => LayoutBuilder(
              builder: (context, constraints) => AlertDialog(
                ...
                title: const Column(
                  children: [
                    ...
                    Text(
                      "Select a backup file in order to continue",
                      style: TextStyle(
                          fontFamily: 'Gilroy',
                          fontWeight: FontWeight.w500,
                          fontSize: 14),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () async {
                                  Get.back();
                                  await promptPasswordRetrieveWalletGoogleDrive(
                                      context, projectSnap.data![index].id!);
                                },
                                child: Padding(
        ...
        _homeController.accessToken.value.isNullOrBlank! ? true : false);
Future<void> promptPasswordRetrieveWalletGoogleDrive(
            ...
            title: const Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8.0),
                  child: Text(
                    "A password is required to decrypt your seed phrase on Google Drive",
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),
                        ...
                        if (_passwordTextController.text.isNotEmpty &&
                          ...
                          await _walletConnectModalController
                              .retrieveWalletFromMnemonic(
                                  context,
                                  await retrieveWalletFromDrive(
                                          _passwordTextController.text, id) ??
                                      "");
                          saveIsLoading.value = false;
                          Get.back();
                        }
...
Future<void> promptRetrieveManually(BuildContext context) async => showDialog(
    context: context,
    builder: (context) => StatefulBuilder(
          builder: (context, setState) => AlertDialog(
            backgroundColor:
            ...
            title: const Column(
              children: [
                ...
                Text(
                  "Write or paste the words composing your seed phrase and validate",
                  style: TextStyle(
                      fontFamily: 'Gilroy',
                      fontWeight: FontWeight.w500,
                      fontSize: 14),
            ...
            content: Obx(() => Column(
                  ...
                  children: [
                      ...
                      child: TextField(
                        ...
                        onChanged: (input) async {
                          ...
                          _walletConnectModalController
                              .errorTextRetrieving.value = false;
                        },
                        autofocus: true,
                        minLines: 4,
                        maxLines: 5,
                        decoration: InputDecoration(
                          hintText:
                              "Example: boat moon hat bottle speaker wallet phone monitor cable paper chair sofa",
                          ...
                          contentPadding: const EdgeInsets.symmetric(
                              horizontal: 12, vertical: 12), // Set padding
                        ),
                      ),
                    ),
                    const SizedBox(
                    ...
                    _walletConnectModalController.errorTextRetrieving.value
                        ? const Text(
                            "This user doesn't exist or the seed phrase is incorrect, try again.",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontFamily: 'Gilroy',
                                color: Colors.red,
            ...
            actions: <Widget>[
              Obx(() => saveIsLoading.value
                  ...
                  : TextButton(
                      onPressed: () async {
                        if (_retrievingTextController.text
                                .trim()
                                .split(' ')
                                .length >=
                            12) {
                          ...
                          await _walletConnectModalController
                              .retrieveWalletFromMnemonic(
                                  context, _retrievingTextController.text);
                          _retrievingTextController.text = "";
                        }
                      },
                      style: TextButton.styleFrom(
                        padding: const EdgeInsets.symmetric(vertical: 12),
                        backgroundColor: _retrievingTextController.text
                                    .trim()
                                    .split(' ')
                                    .length >=
                                12
    ...
    Column(
      ...
      children: [
        Text(
          label,
          style: const TextStyle(
              fontFamily: 'Gilroy', fontWeight: FontWeight.w500, fontSize: 18),
        ),
...
List<String> generateWords(List<String> words, {required int mandatoryIndex}) {
  ...
  while (selectedWords.length < 3) {
    selectedWords
        .add(remainingWords.removeAt(random.nextInt(remainingWords.length)));
  }

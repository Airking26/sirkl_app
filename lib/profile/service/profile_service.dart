...
class ProfileService extends GetConnect{
  ...
  Future<Response<Map<String, dynamic>>> modifyPassword(String accessToken, String wallet, String password) => patch('${con.URL_SERVER}user/modifiPassword/$wallet/$password', "", headers: {'Authorization':'Bearer $accessToken'});

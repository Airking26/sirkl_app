...
class ProfileController extends GetxController{
  ...
  postStory(String url) async{
    var uri = await SimpleS3().uploadFile(File(url), "sirkl-bucket", "eu-central-1:aef70dab-a133-4297-abba-653ca5c77a92", AWSRegions.euCentral1, debugLog: true);
    var storyCreationDto = StoryCreationDto(url: uri);
    var accessToken = box.read(con.ACCESS_TOKEN);
    var refreshToken = box.read(con.REFRESH_TOKEN);

...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.vertical(
            bottom: Radius.circular(_homeController.qrActive.value ? 0 : 35)),
      ...
      children: [
        InkWell(
          onTap: () {
            ...
            pushNewScreen(context,
                    screen: const StoryViewerScreen(), withNavBar: false)
                .then((value) {
              if (value == null) {
        ...
        SizedBox(
          width: 70,
          child: Text(
            _homeController.stories.value != null &&
                    _homeController.stories.value!.length > index
                ? displayName(
  ...
  String displayNameStory(UserDTO createdBy) {
    ...
    if (nickname.isEmpty) {
      ...
      String userDisplayName = userName.isEmpty
          ? "${wallet.substring(0, 3)}..."
          : userName.length > 3
              ? "${userName.substring(0, 4)}..."
              : userName;
      return nickname.length > 5
          ? "${nickname.substring(0, 5)}... ($userDisplayName)"
                  ...
                  _homeController.nicknames[
                      ...
                      ? (_commonController.users[index].userName.isNullOrBlank!
                          ...
                          : _commonController.users[index].userName![0]
                              .toUpperCase())
                      : _homeController
                          .nicknames[_commonController.users[index].wallet][0]
                          .toUpperCase(),
                  softWrap: false,
                  style: TextStyle(
                      fontFamily: "Gilroy",
        ...
        builder: (_) => WillPopScope(
              ...
              child: Obx(() => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        const Text(
                          "Please enter the code to access the Beta version of SIRKL.io",
                          style: TextStyle(
                              fontFamily: 'Gilroy',
                              fontSize: 16,
                              fontWeight: FontWeight.w500),
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: UnderlineInputBorder(
                                borderSide: BorderSide(
                                    color: SColors
                                        .activeColor), // Change active border color
                              ),
                            ))
                      ],
                    ),
                    actions: [
                      _homeController.isCheckingBetaCode.value
                          ? SizedBox(
                              width: 36,
                              height: 36,
                              child: CircularProgressIndicator(
                          ...
                          : TextButton(
                              onPressed: () async {
                                if (_betaTestController.text.isNotEmpty &&
                                    _betaTestController.text.length == 6) {
                                  _homeController.isCheckingBetaCode.value =
                                      true;
        ...
        _homeController.isLoading.value
            ...
            : Column(children: [
                ...
                InkWell(
                  ...
                  child: Text("Retrieve your wallet",
                      style: TextStyle(
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        Text(
                            "Connecting your Wallet to the app allows you to customize the way you experience SIRKL.io",
  ...
  Column buildSignWalletUI() {
    return Column(
      children: [
        ...
        _homeController.isSigning.value
            ? Center(
                child: CircularProgressIndicator(
                  color: SColors.activeColor,
                ),
          ...
          const Expanded(
            ...
            child: Center(
              child: Padding(
                ...
                child: Text(
                  "Generate your QR code from the website 'app.sirkl.io' either from the login page or the header once you are logged in.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 14,
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) async {
      ...
      if (DateTime.now().isBefore(DateTime.fromMillisecondsSinceEpoch(
          int.parse(webWalletConnectDTO.timestamp!) * 1000))) {
        await _homeController.loginWithWallet(
            context,
            webWalletConnectDTO.wallet!.toLowerCase(),
            webWalletConnectDTO.message!,

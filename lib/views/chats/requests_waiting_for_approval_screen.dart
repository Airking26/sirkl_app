...
class RequestWaitingForApprovalScreen extends StatefulWidget {
  ...
  @override
  State<RequestWaitingForApprovalScreen> createState() =>
      _RequestWaitingForApprovalScreenState();
}
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return buildNotificationTile(context,
                            _chatController.requestsWaiting[index], index);
                      }),
                ),
              ))
            ],
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: ListTile(
                  ...
                  onPressed: () async {
                    if (await _chatController.acceptDeclineRequest(
                        RequestToJoinDto(
                            ...
                            accept: true))) {
                      _chatController.requestsWaiting
                          .removeWhere((element) => element.id == item.id);
                      _chatController.requestsWaiting.refresh();
                      if (_chatController.requestsWaiting.isEmpty)
          ...
          leading: item.picture.isNullOrBlank!
              ? SizedBox(
                  height: 50,
                  width: 50,
                  child: TinyAvatar(
          ...
          title: Transform.translate(
            ...
            child: Text(
                "${displayName(item, _homeController)} has requested to join ${_chatController.channel.value!.extraData['nameOfGroup'] as String}",
                style: TextStyle(
                    fontSize: 15,
                    fontFamily: "Gilroy",

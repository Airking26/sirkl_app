...
class _CreateGroupFirstScreenState extends State<CreateGroupFirstScreen> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextField(
                                controller:
                                    _chatController.groupTextController.value,
                                onChanged: (query) {
                                  if (query.isEmpty) {
                                    _chatController.groupNameIsEmpty.value =
                                        true;
                                  } else {
                                    _chatController.groupNameIsEmpty.value =
                                        false;
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: UnderlineInputBorder(
                                    borderSide:
                                        BorderSide(color: SColors.activeColor),
                                  ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  _chatController.groupTypeCollapsed.value =
                                      !_chatController.groupTypeCollapsed.value;
                                },
                                child: Row(
                      ...
                      _chatController.groupTypeCollapsed.value
                          ...
                          : Padding(
                              padding: EdgeInsets.only(
                                  bottom: 16.0,
                                  left: _chatController.groupType.value == 0
                                      ? 0
                                      : 24,
                                  right: 24,
                                  top: 8),
                              child: Text(
                                _chatController.groupType.value == 0
                                    ? "This group is open to everyone interested in joining!"
                                    : "Users can request to join your groups, but access will only be granted upon approval from an admin.",
                      ...
                      SizedBox(
                        height:
                            _chatController.groupVisibilityCollapsed.value ||
                                    _chatController.groupTypeCollapsed.value
                                ? 8
                                : 24,
                      ),
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  _chatController
                                          .groupVisibilityCollapsed.value =
                                      !_chatController
                                          .groupVisibilityCollapsed.value;
                                },
                                child: Row(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  _chatController.groupPayingCollapsed.value =
                                      !_chatController
                                          .groupPayingCollapsed.value;
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment:
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                    ...
                    if (_chatController
                      ...
                      if (_chatController.groupPaying.value == 1) {
                        ...
                        pushNewScreen(context,
                                screen: const CreateGroupSecondScreen(),
                                withNavBar: false)
                            .then((value) {
                  ...
                  child: _web3Controller.loadingToCreateGroup.value
                      ? SizedBox(
                          width: 24,
                          height: 24,
                      ...
                      : Text(
                          "Create",
                          style: TextStyle(
                            color: _chatController.groupNameIsEmpty.value
                                ? Colors.grey
                                : SColors.activeColor,
                            fontFamily: "Gilroy",
                            fontWeight: FontWeight.w600,
  ...
  Future<void> createPaidGroup() async {
    ...
    AlertDialog alert = _web3Controller.blockchainInfo(
        "Please, wait while group is created on the Blockchain. This may take some time.");
    var client = _web3Controller.client;
    var price = double.parse(
            _priceController.text.replaceAll(RegExp('[^A-Za-z0-9]'), '.')) *
        1e18;
        ...
        if (address == event.transactionHash) {
          ...
          var idChannelCreated = await _chatController.createInbox(
              InboxCreationDto(
                  ...
                  isGroupPrivate:
                      _chatController.groupType.value == 0 ? false : true,
                  isGroupVisible:
                      _chatController.groupVisibility.value == 0 ? true : false,
                  isGroupPaying: true,

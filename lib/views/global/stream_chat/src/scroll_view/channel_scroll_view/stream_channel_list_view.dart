...
import 'package:sirkl/views/global/stream_chat/src/scroll_view/stream_scroll_view_loading_widget.dart';
...
class StreamChannelListView extends StatefulWidget {
  ...
  final void Function(BuildContext, String, StreamChatClient)?
      onChannelAddPressed;
    ...
    return PagedValueListView<int, Channel>(
      ...
      itemBuilder: (context, channels, index) {
        ...
        final streamChannelListTile = StreamChannelListTile(
          ...
          channel: channel,
          onFavPressed: onFavPressed == null
              ? null
              : (context) => onFavPressed(context, channel),
          onDeletePressed: onDeletePressed == null
              ? null
              : (context) => onDeletePressed(context, channel),
          onAddPressed: onAddPressed == null
              ? null
              : (context) => onAddPressed(
                  context,
                  userFromJson(json.encode(channel.state?.members
                          .where((element) =>
                              element.userId !=

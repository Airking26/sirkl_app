...
import 'package:sirkl/views/global/stream_chat/src/message_input/attachment_button.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/command_button.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/dm_checkbox.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/quoted_message_widget.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/quoting_message_top_area.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/simple_safe_area.dart';
import 'package:sirkl/views/global/stream_chat/src/message_input/tld.dart';
...
class StreamMessageInputState extends State<StreamMessageInput>
  ...
  Future<void> sendMessage() async {
    ...
    try {
      ...
      } else if (resp.message?.state ==
              MessageState.completed(state: CompletedState.sent()) &&
          streamChannel.channel.extraData['isConv'] == null) {
        _gamificationController.updateTaskProgress(TaskProgressUpdateDto(
            taskName: GamificationDailyTasks.communityInteraction.displayName,

...
class _MyStoryViewerScreenState extends State<MyStoryViewerScreen> {
  ...
  @override
  void initState() {
    storyItems = _profileController.myStories.value!
        .map((e) => e.type == 0
            ? StoryItem.pageImage(
                url: e.url,
          ...
          StoryView(
            ...
            onVerticalSwipeComplete: (direction) async {
              if (direction == Direction.down) {
                ...
                controller.pause();
                await _profileController.retrieveUsersForAStory(
                    _profileController.myStories.value![currentIndex].id);
                showModalBottomSheet(
                    context: context,
                    builder: (context) {
                      return _profileController.readers.value == null ||
                              _profileController.readers.value?.length == 0
                          ? const Padding(
                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      showModalBottomSheet(
                          ...
                          builder: (context) {
                            return _profileController.readers.value == null ||
                                    _profileController.readers.value?.length ==
                                        0
                                ? const Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: 24.0, vertical: 48),
                                    ...
                                    child: Text("Yes",
                                        style: TextStyle(
                                            ...
                                            color: MediaQuery.of(context)
                                                ...
                                                : Colors.black)),
                                    onPressed: () async {
                                      await _homeController.deleteStory(
                                          _profileController
                                              .myStories
                                              .value![currentIndex]
                                              .createdBy
                                              .id!,
                                          _profileController.myStories
                                              .value![currentIndex].id);
                                      _profileController.myStories.value
                                          ?.removeWhere((element) =>
                                              element.id ==
                                              _profileController.myStories
                                                  .value![currentIndex].id);
        ...
        return ListTile(
          leading: InkWell(
            onTap: () {
              ...
              pushNewScreen(context,
                      ...
                      withNavBar: true)
                  .then(
                      (value) => _navigationController.hideNavBar.value = true);
            },
            child: _profileController.readers.value?[index].picture == null
                ? SizedBox(
                    ...
                    child: TinyAvatar(
                      baseString:
                          _profileController.readers.value![index].wallet!,
                      dimension: 56,
                      circular: true,
                ...
                : ClipRRect(
                    ...
                    child: CachedNetworkImage(
                        imageUrl:
                            _profileController.readers.value![index].picture!,
                        width: 56,
                        height: 56,
                        fit: BoxFit.cover,
          ...
          title: InkWell(
              ...
              child: Transform.translate(
                  ...
                  child: Text(
                      displayName(_profileController.readers.value![index],
                          _homeController),
                      maxLines: 2,
          ...
          subtitle: !_profileController
                  .readers.value![index].userName.isNullOrBlank!
              ? InkWell(
                  onTap: () {
                    _commonController.userClicked.value =
                        _profileController.readers.value![index];
                  ...
                  child: Transform.translate(
                      offset: const Offset(-8, 0),
                      child: Text(
                          "${_profileController.readers.value![index].wallet!.substring(0, 6)}...${_profileController.readers.value![index].wallet!.substring(_profileController.readers.value![index].wallet!.length - 4)}",
                          //maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              fontSize: 13,

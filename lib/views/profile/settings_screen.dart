                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          pushNewScreen(context,
                              screen: const MyCommunityScreen());
                        },
                        child: const Padding(
                          padding: EdgeInsets.symmetric(vertical: 8.0),
                          child: Text(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              height: 20,
                              child: Switch(
                                value: _homeController.notificationActive.value,
                                onChanged: (active) async {
                                  ...
                                  _homeController
                                      .switchActiveNotification(active);
                                },
                      ...
                      seedPhrase.value == null
                          ...
                          : Column(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async =>
                                      await promptChoseBackupMethod(context),
                                  child: const Padding(
                                    padding:
                      ...
                      _homeController.userMe.value.userName == null ||
                              _homeController.userMe.value.userName!.isEmpty
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InkWell(
                                  onTap: () async => await _profileController
                                      .promptClaimUsername(context),
                                  child: const Padding(
                                    padding:
                                        EdgeInsets.symmetric(vertical: 8.0),
                                    child: Text(
                                    ...
                                    actions: [
                                      ...
                                      CupertinoDialogAction(
                                        ...
                                        onPressed: () async {
                                          ...
                                          _homeController
                                              .streamChatToken.value = "";
                                          _navigationController.controller.value
                                              .jumpToTab(0);

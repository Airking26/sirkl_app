...
class SettingsProfileElseScreen extends StatefulWidget {
  const SettingsProfileElseScreen(
      {Key? key, required this.fromConversation, required this.fromProfile})
      : super(key: key);
  final bool fromConversation;
  final bool fromProfile;

  @override
  State<SettingsProfileElseScreen> createState() =>
      _SettingsProfileElseScreenState();
}
                  ...
                  child: ClipOval(
                    child: SizedBox.fromSize(
                      ...
                      child: _commonController
                              .userClicked.value!.picture.isNullOrBlank!
                          ? TinyAvatar(
                              baseString:
                          ...
                          : CachedNetworkImage(
                              imageUrl:
                                  _commonController.userClicked.value!.picture!,
                              ...
                              if (await _commonController.addUserToSirkl(
                                ...
                                showToast(
                                    ...
                                    con.userAddedToSirklRes.trParams({
                                      "user": _commonController.userClicked
                    ...
                    InkWell(
                      onTap: () async {
                        var uri = await _profileController.createDynamicLink(
                            "/profileShared?id=${_commonController.userClicked.value!.id!}");
                        Share.share(
                            "Check out this profile on SIRKL ${uri.toString()}");
                      },
                      child: Material(
                        borderRadius: BorderRadius.circular(10),
                        elevation: 5,
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          _profileController.usernameElseTextEditingController
                              .value.text = _homeController.nicknames[
                                  _commonController
                        ...
                        child: const Padding(
                          padding: EdgeInsets.symmetric(vertical: 8.0),
                          child: Text(
                            "Edit nickname (only visible by you)",
                            style: TextStyle(
                                fontFamily: "Gilroy",
                                fontSize: 18,
                                fontWeight: FontWeight.w500),
                            ...
                            SizedBox(
                              ...
                              child: Switch(
                                value: _commonController
                                    ...
                                    !_homeController.userBlocked.value.contains(
                                        _commonController
                                            .userClicked.value!.id!),
                                onChanged: _commonController
                                        .userClickedFollowStatus.value
                                    ? (active) async {
                                        if (!active) {
                                          if (!_homeController.userBlocked
                                              .contains(_commonController
                                                  .userClicked.value!.id!)) {
                                            _homeController.userBlocked.assign(
                                                _commonController
                                                    .userClicked.value!.id!);
                                          }
                      ...
                      _commonController.userClickedFollowStatus.value
                          ? InkWell(
                              onTap: () async {
                                if (await _commonController.removeUserToSirkl(
                                    _commonController.userClicked.value!.id!,
                                    StreamChat.of(context).client,
                                    _homeController.id.value)) {
                                  showToast(
                                            ...
                                            style: TextStyle(
                                                ...
                                                color: MediaQuery.of(context)
                                                    ...
                                                    : Colors.black
                                                        .withOpacity(0.5))),
                                        onPressed: () async {
                                          await _commonController.report(
                                              context,
                                              ReportDto(
                                                  createdBy:
                                                      _homeController.id.value,
                                                  idSignaled: _commonController
                                                      .userClicked.value!.id!,
                                                  description:
                                        ...
                                        onPressed: () async {
                                          await _commonController.report(
                                              ...
                                              ReportDto(
                                                  ...
                                                  idSignaled: _commonController
                                                      .userClicked.value!.id!,
                                                  description: "Spam or scams",
                                                  type: 0));
                                          Get.back();
                                        },
                                      ),
                                      CupertinoDialogAction(
                                        child: Text("Privacy violations",
                                            style: TextStyle(
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600,
                                                fontFamily: "Gilroy",
          ...
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: _profileController.isEditingProfileElse.value
                    ? SizedBox(
                        width: 200,
                        child: TextField(
                          autofocus: true,
                    ...
                    : Text(
                        displayName(_commonController.userClicked.value!,
                            _homeController),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 20,
                  ...
                  ? InkWell(
                      onTap: () async {
                        ...
                        _homeController.updateNickname(
                            _commonController.userClicked.value!.wallet!,
                            _profileController
                                .usernameElseTextEditingController.value.text);
                        _profileController.isEditingProfileElse.value = false;
                        _profileController
                            .usernameElseTextEditingController.value
                            .clear();
                        _commonController
                            .showSirklUsers(_homeController.id.value);
                      },
                      child: Padding(

...
import 'package:sirkl/views/notification_gamification/gamification_navigation_screen.dart';
...
class _NotificationScreenState extends State<NotificationScreen>
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  buildNotificationTab(context),
                  GamificationNavigationScreen(),
                ],
              ),
            )
          ],
  ...
  MediaQuery buildNotificationTab(BuildContext context) {
                      ...
                      child: Align(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            MediaQuery.of(context).platformBrightness ==
                                    Brightness.dark
                                ? "assets/images/octo_light.jpeg"
                                : "assets/images/octo_dark.jpeg",
                          ),
                        ),
                      ),
                    )
  ...
  Widget? buildTextNotif(NotificationDto item) {
    ...
    if (item.type == 0) {
      ...
      return RichText(
        ...
        item.type == 8 ||
        item.type == 10) {
      return Text(item.message! + ' · ' + timeago.format(timeSince),
          style: TextStyle(
              fontSize: 14,
              fontFamily: "Gilroy",
              fontWeight: FontWeight.w500,

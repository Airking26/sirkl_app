              ...
              Align(
                ...
                child: ClipOval(
                  child: SizedBox.fromSize(
                    ...
                    child: _chatController.channel.value!.extraData["image"] ==
                            null
                        ? TinyAvatar(
                            baseString: _chatController
                                .channel.value!.extraData['name'] as String,
                            dimension: 140,
                            circular: true,
                            colourScheme: TinyAvatarColourScheme.seascape)
                        : CachedNetworkImage(
                            imageUrl: _chatController
                                .channel.value!.extraData["image"] as String,
                  ...
                  InkWell(
                    onTap: () async {
                      var uri = await _profileController.createDynamicLink(
                          "/joinGroup?id=${_chatController.channel.value!.id!}");
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          "Participants (${_chatController.channel.value!.memberCount! - 3})",
                    ...
                    InkWell(
                      onTap: () async {
                        if (_chatController.channel.value!.extraData["owner"] ==
                          ...
                          pushNewScreen(context,
                              screen: const PinnedMessageScreen());
                        } else {
                          if (_chatController
